...
namespace ComiqueriaLogic
{
    public class Comiqueria
    {
        ...
        public Comiqueria()
        {
             ...
             */
            this.productos = SQLConector.Leer();
            SQLConector.MiEvento += ActualizarListaProductos;
            this.ventas = new List<Venta>();
            //productosListChanged += SQLConector.Leer;
        }
        ...
        public void Vender(Producto producto, int cantidad)
        {
            ...
            Serializador<Venta>.GuardarBin(ruta, nuevaVenta);
