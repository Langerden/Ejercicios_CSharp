...
namespace _20180628_SP.v1
{
    public partial class FrmSenadores : Form
    {
        ...
        readonly string ruta = AppDomain.CurrentDomain.BaseDirectory + "\\Votacion.xml";
        ...
        public void ManejadorVoto(string senador, Votacion.EVoto voto)
        {
            ...
            else
            {
                ...
                if (aux == 0)
                {
                    ...
                    SerializarXML<Votacion> serializar = new SerializarXML<Votacion>();

                    dao.Guardar("Votaciones", this.votacion);
                    serializar.Guardar(this.ruta, this.votacion);
                }
            }
        }
        ...
        private void btnSimular_Click(object sender, EventArgs e)
        {
            ...
            // EVENTO
            this.votacion.EventoVotoEfectuado += this.ManejadorVoto;
            // THREAD
